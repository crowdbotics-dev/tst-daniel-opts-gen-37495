...
## Project Structure
    ...
    ├── tst_daniel_opts_gen_37495  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_opts_gen_37495`
...
2. Clone this repo and `cd tst_daniel_opts_gen_37495`
